    ...
    return(
        ...
        <main id='skills' className='py-6 px-4 sm:p-6 md:py-10 md:px-8'>
            <div className='max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2'>
                <div data-aos='fade-up' data-aos-delay='300' className='relative p-3 col-start-1 row-start-1 flex flex-col-reverse rounded-lg bg-gradiant-to-t from-black/75 via-black/0 sm:bg-none sm:row-start-2 sm:p-0 lg:row-start-1'>
                ...
                <div data-aos='fade-up' data-aos-delay='300' className='grid ga-4 col-start-1 col-end-3 row-start-1 sm:mb-6 sm:grid-cols-4 lg:gap-6 lg:col-start-2 lg:row-end-6 lg:row-span-6 lg:mb-0'>
               ...
               <div className='mt-4 md:col-start-1 md:row-start-3 self-center lg:mt-2 lg:col-start-1 lg:row-start-3 lg:row-end-4'>
                <a href={RESUME} download>
                 ...
                 <p dat-aos='fade-up' data-aos-delay='600'className='mt-4 text-sm leading-6 col-start-1 sm:col-span-2 lg:mt-6 lg:row-start-4 text-blue-950 lg:col-span-1'>
                   I am a results-driven full-stack developer passionate about building scalable,
                    high-performance web applications with clean architecture and intuitive user experiences.
                     With strong expertise in HTML, CSS, JavaScript, React, Node.js, Express, MongoDB, 
                     and SQL, along with a solid foundation in Data Structures & Algorithms and programming
                      in Java, Python, and C, I focus on writing efficient,
                    maintainable code that delivers real business value and solves real-world problems.
                 </p>
